...
engine = chess.engine.SimpleEngine.popen_uci(r"C:\Users\KISHORE S\Desktop\chessbottv2\ChessBot\ChessRobotArm\stockfish\stockfish-windows-2022-x86-64-avx2.exe")
